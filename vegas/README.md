...
ORG_ID=$(terraform output -raw organization_id  2>/dev/null || \
         terraform show -json | python3 -c "import json,sys; \
         r=[r for r in json.load(sys.stdin)['values']['root_module']['resources'] \
         if r['type']=='confluent_organization']; print(r[0]['values']['id'])")
